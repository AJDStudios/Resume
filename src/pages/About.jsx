    ...
    return (
        <>
            ...
            <div className="about">
                ...
                <p className="abouttext"> <br></br><br></br>I'm Aaron, or A.D, whichever you prefer. I've worked in many fields with the mantra "no matter what you happen to be, make sure you're a good one." 
