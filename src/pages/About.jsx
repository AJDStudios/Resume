...
export default function About() {
    return (
        <>
            ...
            <div className="about">
                <img className="profile" src={ profiledark } alt=""/>
                <p className="abouttext">I'm Aaron, or A.D, whichever you prefer. I've worked in many fields with the mantra "no matter what you happen to be, make sure you're a good one." 
